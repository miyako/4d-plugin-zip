...
extern int ZEXPORT zipWriteInFileInZip_noAES OF((zipFile file, const void* buf, unsigned len));
...
extern int ZEXPORT zipCloseFileInZipRaw64_noAES OF((zipFile file, ZPOS64_T uncompressed_size, uLong crc32));
