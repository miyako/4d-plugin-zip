...
void Unzip(sLONG_PTR *pResult, PackagePtr pParams)
{
    ...
    if(method_id)
    {
        ...
        params[6] = PA_CreateVariable(eVK_Undefined);
        params[7] = PA_CreateVariable(eVK_Undefined);
    }else{
        params[0] = PA_CreateVariable(eVK_Unistring);
                            ...
                            if(isCallbackSet)
                            {
                                ...
                                if(elapsedTime > 0)
                                {
                                    ...
                                    if(method_id)
                                    {
                                        ...
                                        PA_Variable result = PA_ExecuteMethodByID(method_id, params, 6);
...
void Zip(sLONG_PTR *pResult, PackagePtr pParams)
{
    ...
    if(method_id)
    {
        ...
        params[2] = PA_CreateVariable(eVK_Real);
        params[3] = PA_CreateVariable(eVK_Real);
        params[4] = PA_CreateVariable(eVK_Undefined);
        params[5] = PA_CreateVariable(eVK_Undefined);
    }else{
        params[0] = PA_CreateVariable(eVK_Unistring);
        params[1] = PA_CreateVariable(eVK_Boolean);
        params[2] = PA_CreateVariable(eVK_Unistring);
                    ...
                    if(isCallbackSet)
                    {
                        ...
                        if(elapsedTime > 0)
                        {
                            ...
                            if(method_id)
                            {
                                ...
                                PA_Variable result = PA_ExecuteMethodByID(method_id, params, 4);
